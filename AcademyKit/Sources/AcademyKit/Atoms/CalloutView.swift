...
///View que mostra um texto de callout do nosso pacote
public struct CalloutView: View {
    ...
    public var body: some View {
        Text(text)
            .font(.custom(weight == .regularWeight && italic == false ? "Cygre-Regular" : weight == .regularWeight && italic == true ? "Cygre-RegularIt" : weight == .boldWeight && italic == false ? "Cygre-Bold" : "Cygre-BoldIt", size: 16))
    }
}


#Preview {
    CalloutView(text: "Callout",weight:.boldWeight, italic: false)
}
